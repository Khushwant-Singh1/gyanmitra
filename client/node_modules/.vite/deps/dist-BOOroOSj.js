		...
		function scan(tile, pos) {
			for (let i = 0, off = 0; i < tile.children.length && off <= pos; i++) {
				...
				if (end >= pos) {
					...
					else if ((!after || after.isHidden && (side > 0 && !(after.flags & 32) || forCoords && onSameLine(after, child))) && (end > pos || child.flags & 32)) {
						after = child;
						afterOff = pos - off;
...
//#endregion
export { WidgetType as $, indentUnit as A, Prec as At, IterMode as B, combineConfig as Bt, foldNodeProp as C, ChangeSet as Ct, indentNodeProp as D, EditorState as Dt, getIndentation as E, EditorSelection as Et, syntaxTree as F, StateField as Ft, Parser as G, NodeSet as H, findClusterBreak as Ht, Tag as I, Text as It, Decoration as J, Tree as K, highlightTree as L, Transaction as Lt, matchBrackets as M, RangeSetBuilder as Mt, sublanguageProp as N, RangeValue as Nt, indentOnInput as O, Facet as Ot, syntaxHighlighting as P, StateEffect as Pt, ViewPlugin as Q, styleTags as R, codePointAt as Rt, foldKeymap as S, ChangeDesc as St, getIndentUnit as T, Compartment as Tt, NodeType as U, fromCodePoint as Ut, NodeProp as V, countColumn as Vt, NodeWeakMap as W, EditorView as X, Direction as Y, GutterMarker as Z, defineLanguageFacet as _, showPanel as _t, HighlightStyle as a, getTooltip as at, foldGutter as b, StyleModule as bt, Language as c, highlightActiveLineGutter as ct, ParseContext as d, keymap as dt, activateHover as et, StreamLanguage as f, lineNumbers as ft, defaultHighlightStyle as g, showDialog as gt, continuedIndent as h, runScopeHandlers as ht, LocalTokenGroup as i, getPanel as it, languageDataProp as j, RangeSet as jt, indentString as k, MapMode as kt, LanguageDescription as l, highlightSpecialChars as lt, bracketMatchingHandle as m, rectangularSelection as mt, ExternalTokenizer as n, drawSelection as nt, IndentContext as o, gutter as ot, bracketMatching as p, logException as pt, parseMixed as q, LRParser as r, dropCursor as rt, LRLanguage as s, highlightActiveLine as st, ContextTracker as t, crosshairCursor as tt, LanguageSupport as u, hoverTooltip as ut, delimitedIndent as v, showTooltip as vt, foldService as w, CharCategory as wt, foldInside as x, Annotation as xt, flatIndent as y, crelt as yt, tags as z, codePointSize as zt };

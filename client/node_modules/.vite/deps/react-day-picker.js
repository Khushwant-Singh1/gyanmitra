...
import { d as startOfWeek, n as enUS } from "./isSameWeek-2C4ep9PG.js";
import { A as setMonth, Kr as differenceInCalendarMonths, Oi as addMonths, Pr as endOfMonth, Pt as isSameYear, Qr as isSameDay, Rt as isSameMonth, Zn as getWeek, Zr as isDate, _i as differenceInCalendarDays, an as isBefore, bi as startOfISOWeek, er as getISOWeek, hn as getWeeksInMonth, hr as startOfYear, ki as addDays, li as addYears, lr as endOfISOWeek, oi as min, on as isAfter, qn as format, qt as parse, si as max, ui as addWeeks, ur as endOfWeek, vi as startOfDay, vn as getUnixTime, vr as startOfMonth, y as setYear, yt as subDays } from "./date-fns-CmGXXPWB.js";
//#region node_modules/.pnpm/react-day-picker@8.10.2_date-fns@3.6.0_react@18.3.1/node_modules/react-day-picker/dist/index.esm.js
...
function DayPickerProvider(props) {
	...
	return (0, import_jsx_runtime.jsx)(DayPickerContext.Provider, {
		value,
...
function IconDropdown(props) {
	return (0, import_jsx_runtime.jsx)("svg", __assign({
		width: "8px",
		height: "8px",
		viewBox: "0 0 120 120",
		"data-testid": "iconDropdown"
	}, props, { children: (0, import_jsx_runtime.jsx)("path", {
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime.jsxs)("div", {
				...
				"aria-hidden": "true",
				children: [caption, (0, import_jsx_runtime.jsx)(IconDropdownComponent, {
...
function MonthsDropdown(props) {
	...
	if (!fromDate) return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {});
	if (!toDate) return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {});
	var dropdownMonths = [];
	...
	return (0, import_jsx_runtime.jsx)((_a = components === null || components === void 0 ? void 0 : components.Dropdown) !== null && _a !== void 0 ? _a : Dropdown, {
		name: "months",
...
function NavigationProvider(props) {
	...
	return (0, import_jsx_runtime.jsx)(NavigationContext.Provider, {
		value,
		children: props.children
	});
}
...
function CaptionDropdowns(props) {
	...
	var captionLabel = (0, import_jsx_runtime.jsx)((_a = components === null || components === void 0 ? void 0 : components.CaptionLabel) !== null && _a !== void 0 ? _a : CaptionLabel, {
		id: props.id,
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime.jsx)(MonthsDropdown, {
				onChange: handleMonthChange,
				displayMonth: props.displayMonth
			}),
			(0, import_jsx_runtime.jsx)(YearsDropdown, {
				onChange: handleMonthChange,
				displayMonth: props.displayMonth
			})
		]
...
var Button = (0, import_react.forwardRef)(function(props, ref) {
	...
	return (0, import_jsx_runtime.jsx)("button", __assign({}, props, {
		ref,
		type: "button",
		className,
		style
...
function Navigation(props) {
	...
	if (!props.nextMonth && !props.previousMonth) return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {});
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		style: styles.nav,
		children: [!props.hidePrevious && (0, import_jsx_runtime.jsx)(Button, {
			name: "previous-month",
			...
			children: dir === "rtl" ? (0, import_jsx_runtime.jsx)(IconRightComponent, {
				className: classNames.nav_icon,
				style: styles.nav_icon
			}) : (0, import_jsx_runtime.jsx)(IconLeftComponent, {
				className: classNames.nav_icon,
				style: styles.nav_icon
			})
		}), !props.hideNext && (0, import_jsx_runtime.jsx)(Button, {
			name: "next-month",
			...
			children: dir === "rtl" ? (0, import_jsx_runtime.jsx)(IconLeftComponent, {
				className: classNames.nav_icon,
				style: styles.nav_icon
			}) : (0, import_jsx_runtime.jsx)(IconRightComponent, {
				className: classNames.nav_icon,
				style: styles.nav_icon
			})
		})]
...
function Caption(props) {
	...
	var caption;
	if (disableNavigation) caption = (0, import_jsx_runtime.jsx)(CaptionLabelComponent, {
		id: props.id,
		displayMonth: props.displayMonth
	});
	else if (captionLayout === "dropdown") caption = (0, import_jsx_runtime.jsx)(CaptionDropdowns, {
		displayMonth: props.displayMonth,
		id: props.id
	});
	else if (captionLayout === "dropdown-buttons") caption = (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)(CaptionDropdowns, {
		displayMonth: props.displayMonth,
		displayIndex: props.displayIndex,
		id: props.id
	}), (0, import_jsx_runtime.jsx)(CaptionNavigation, {
		displayMonth: props.displayMonth,
		displayIndex: props.displayIndex,
		id: props.id
	})] });
	else caption = (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)(CaptionLabelComponent, {
		id: props.id,
		displayMonth: props.displayMonth,
		displayIndex: props.displayIndex
	}), (0, import_jsx_runtime.jsx)(CaptionNavigation, {
...
function Footer(props) {
	...
	if (!footer) return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {});
	return (0, import_jsx_runtime.jsx)("tfoot", {
		className: tfoot,
		style: styles.tfoot,
		children: (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", {
			colSpan: 8,
			children: footer
		}) })
	});
...
function HeadRow() {
	...
	return (0, import_jsx_runtime.jsxs)("tr", {
		...
		children: [showWeekNumber && (0, import_jsx_runtime.jsx)("td", {
...
function Head() {
	...
	return (0, import_jsx_runtime.jsx)("thead", {
		...
		children: (0, import_jsx_runtime.jsx)(HeadRowComponent, {})
	});
}
/** Render the content of the day cell. */
function DayContent(props) {
	var _a = useDayPicker(), locale = _a.locale, formatDay = _a.formatters.formatDay;
	return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: formatDay(props.date, { locale }) });
}
/**
...
function SelectMultipleProvider(props) {
	if (!isDayPickerMultiple(props.initialProps)) return (0, import_jsx_runtime.jsx)(SelectMultipleContext.Provider, {
		value: {
			selected: void 0,
			modifiers: { disabled: [] }
		},
	...
	return (0, import_jsx_runtime.jsx)(SelectMultipleProviderInternal, {
...
function SelectMultipleProviderInternal(_a) {
	...
	return (0, import_jsx_runtime.jsx)(SelectMultipleContext.Provider, {
		value: contextValue,
		children
	});
}
...
function SelectRangeProvider(props) {
	if (!isDayPickerRange(props.initialProps)) return (0, import_jsx_runtime.jsx)(SelectRangeContext.Provider, {
		value: {
			selected: void 0,
			modifiers: {
				range_start: [],
	...
	return (0, import_jsx_runtime.jsx)(SelectRangeProviderInternal, {
		initialProps: props.initialProps,
		children: props.children
	});
}
function SelectRangeProviderInternal(_a) {
	...
	return (0, import_jsx_runtime.jsx)(SelectRangeContext.Provider, {
		value: {
			selected,
			onDayClick,
			modifiers
...
function ModifiersProvider(props) {
	...
	return (0, import_jsx_runtime.jsx)(ModifiersContext.Provider, {
		value: modifiers,
		children: props.children
	});
}
...
function FocusProvider(props) {
	...
	return (0, import_jsx_runtime.jsx)(FocusContext.Provider, {
		value,
		children: props.children
	});
}
...
function SelectSingleProvider(props) {
	if (!isDayPickerSingle(props.initialProps)) return (0, import_jsx_runtime.jsx)(SelectSingleContext.Provider, {
		value: { selected: void 0 },
		children: props.children
	});
	return (0, import_jsx_runtime.jsx)(SelectSingleProviderInternal, {
		initialProps: props.initialProps,
		children: props.children
	});
}
function SelectSingleProviderInternal(_a) {
	...
	return (0, import_jsx_runtime.jsx)(SelectSingleContext.Provider, {
		value: contextValue,
		children
	});
}
...
function useDayRender(day, displayMonth, buttonRef) {
	...
	var divProps = {
		style,
		className,
		children: (0, import_jsx_runtime.jsx)((_c = (_b = dayPicker.components) === null || _b === void 0 ? void 0 : _b.DayContent) !== null && _c !== void 0 ? _c : DayContent, {
			date: day,
			displayMonth,
			activeModifiers
		}),
...
function Day(props) {
	...
	if (dayRender.isHidden) return (0, import_jsx_runtime.jsx)("div", { role: "gridcell" });
	if (!dayRender.isButton) return (0, import_jsx_runtime.jsx)("div", __assign({}, dayRender.divProps));
	return (0, import_jsx_runtime.jsx)(Button, __assign({
		name: "day",
		ref: buttonRef
...
function WeekNumber(props) {
	...
	if (!onWeekNumberClick) return (0, import_jsx_runtime.jsx)("span", {
...
function Row(props) {
	...
	var weekNumberCell;
	if (showWeekNumber) weekNumberCell = (0, import_jsx_runtime.jsx)("td", {
		className: classNames.cell,
		style: styles.cell,
		children: (0, import_jsx_runtime.jsx)(WeeknumberComponent, {
	...
	return (0, import_jsx_runtime.jsxs)("tr", {
		...
		children: [weekNumberCell, props.dates.map(function(date) {
			return (0, import_jsx_runtime.jsx)("td", {
				...
				style: styles.cell,
				role: "presentation",
				children: (0, import_jsx_runtime.jsx)(DayComponent, {
					displayMonth: props.displayMonth,
					date
				})
			}, getUnixTime(date));
...
function Table(props) {
	...
	return (0, import_jsx_runtime.jsxs)("table", {
		...
		children: [
			!hideHead && (0, import_jsx_runtime.jsx)(HeadComponent, {}),
...
function useId(providedId) {
	var _a;
	var _b = (0, import_react.useState)(providedId !== null && providedId !== void 0 ? providedId : serverHandoffComplete ? genId() : null), id = _b[0], setId = _b[1];
...
function Month(props) {
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		style,
		children: [(0, import_jsx_runtime.jsx)(CaptionComponent, {
			id: captionId,
			displayMonth: props.displayMonth,
			displayIndex: props.displayIndex
		}), (0, import_jsx_runtime.jsx)(Table, {
			id: tableId,
...
function Root(_a) {
	...
	}, dataAttributes, { children: (0, import_jsx_runtime.jsx)(MonthsComponent, { children: navigation.displayMonths.map(function(month, i) {
		return (0, import_jsx_runtime.jsx)(Month, {
			displayIndex: i,
			displayMonth: month
		}, i);
	}) }) }));
...
function RootProvider(props) {
	...
	return (0, import_jsx_runtime.jsx)(DayPickerProvider, {
		initialProps,
		children: (0, import_jsx_runtime.jsx)(NavigationProvider, { children: (0, import_jsx_runtime.jsx)(SelectSingleProvider, {
			initialProps,
			children: (0, import_jsx_runtime.jsx)(SelectMultipleProvider, {
				initialProps,
				children: (0, import_jsx_runtime.jsx)(SelectRangeProvider, {
					initialProps,
					children: (0, import_jsx_runtime.jsx)(ModifiersProvider, { children: (0, import_jsx_runtime.jsx)(FocusProvider, { children }) })
				})
			})
		}) })
	});
...
function useInput(options) {
	...
	var _e = (0, import_react.useState)(defaultSelected !== null && defaultSelected !== void 0 ? defaultSelected : today), month = _e[0], setMonth = _e[1];
	...
	var handleBlur = function(e) {
		if (!isValidDate(parseValue(e.target.value))) reset();
	};
	var handleFocus = function(e) {
		...
		var day = parseValue(e.target.value);
		if (isValidDate(day)) setMonth(day);
	};
	return {
		dayPickerProps: {
			month,

...
import { C as useQueryClient, z as onlineManager } from "./modern-Cs4cCW-u.js";
import { G as setupStyleSheet, I as mergeProps, P as lazy, V as render, m as createComponent, x as createSignal } from "./M4GWWVAC-CFVxgh6P.js";
//#region node_modules/.pnpm/@tanstack+query-devtools@5.101.2/node_modules/@tanstack/query-devtools/build/dev.js
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./SO26Z5QU-Dxb5SUgE.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./MYKLHYJZ-jFqbaIaY.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query-devtools@5.101.2_@tanstack+react-query@5.101.2_react@18.3.1__react@18.3.1/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtools.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query-devtools@5.101.2_@tanstack+react-query@5.101.2_react@18.3.1__react@18.3.1/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtoolsPanel.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query-devtools@5.101.2_@tanstack+react-query@5.101.2_react@18.3.1__react@18.3.1/node_modules/@tanstack/react-query-devtools/build/modern/index.js

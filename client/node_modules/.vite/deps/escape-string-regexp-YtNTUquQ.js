import { t as ok } from "./development-CV7dhzN4.js";
import { c as markdownLineEnding, l as markdownLineEndingOrSpace, m as codes, u as markdownSpace } from "./dev-P-QfQAQJ.js";
import { a as factorySpace, d as constants, i as toString, l as splice, o as resolveAll, s as classifyCharacter, u as types } from "./blank-line-CUD_xWZO.js";
import { r as convert } from "./lib-CYOlWLKh.js";
import { t as visit } from "./lib-BgMsJJ8w.js";
...
function tokenizeTasklistCheck(effects, ok$2, nok) {
	...
	*/
	function after(code) {
		if (markdownLineEnding(code)) return ok$2(code);
		if (markdownSpace(code)) return effects.check({ tokenize: spaceThenNonSpace }, ok$2, nok)(code);
		return nok(code);
	}
}
/**
...
//#endregion
export { gfmTaskListItemFromMarkdown as a, handle as c, formatCodeAsIndented as d, patternInScope as f, gfmStrikethrough as h, gfmTableToMarkdown as i, formatHeadingAsSetext as l, gfmStrikethroughToMarkdown as m, gfmTable as n, gfmTaskListItemToMarkdown as o, gfmStrikethroughFromMarkdown as p, gfmTableFromMarkdown as r, gfmTaskListItem as s, escapeStringRegexp as t, encodeCharacterReference as u };
